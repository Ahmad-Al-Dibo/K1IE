      ...
      <div className="row">
        <div className="import_m clearfix">
          ...
          <div className="import_i clearfix">
            <div className="col-sm-4">
              <div className="import_ii text-center clearfix">
                <img src="img/44.jpg" className="iw" alt="abc" />
                <h4>
            ...
            <div className="col-sm-4">
              <div className="import_ii text-center clearfix">
                <img src="img/45.jpg" className="iw" alt="abc" />
                <h4>
                  <a className="c_text" href="#">
                    Sed Cursus{" "}
                  </a>
            ...
            <div className="col-sm-4">
              <div className="import_ii text-center clearfix">
                <img src="img/46.jpg" className="iw" alt="abc" />
                <h4>
                  <a className="c_text" href="#">
                    Nulla Quis
                  </a>
          ...
          <div className="import_i clearfix">
            <div className="col-sm-4">
              <div className="import_ii text-center clearfix">
                <img src="img/47.png" className="iw" alt="abc" />
                <h4>
                  <a className="c_text" href="#">
                    Lorem Ipsum
                  </a>
            ...
            <div className="col-sm-4">
              <div className="import_ii text-center clearfix">
                <img src="img/48.jpg" className="iw" alt="abc" />
                <h4>
                  <a className="c_text" href="#">
                    Sed Cursus{" "}
                  </a>
            ...
            <div className="col-sm-4">
              <div className="import_ii text-center clearfix">
                <img src="img/49.jpg" className="iw" alt="abc" />
                <h4>
                  <a className="c_text" href="#">
                    Nulla Quis
                  </a>
